...
int main() {
    ...
    ///texture
    unsigned diffuseMap = loadTexture("textures/brickwall.jpg");
    unsigned normalMap = loadTexture("textures/brickwall_normal.jpg");
    ///build & compile shaders
    Shader pass1Shader("shader/pass1_NormalMap.vs", "shader/pass1_NormalMap.fs");
    ///put light
